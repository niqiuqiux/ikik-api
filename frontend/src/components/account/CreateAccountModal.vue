  ...
  >
    ...
    >
      ...
      <div>
        ...
        <div class="mt-2 grid grid-cols-2 gap-1 rounded-lg bg-gray-100 p-1 sm:grid-cols-4 lg:grid-cols-5 dark:bg-dark-700" data-tour="account-form-platform">
          <button
            type="button"
          ...
          <button
            ...
            :class="[
              'flex flex-1 items-center justify-center gap-2 rounded-md px-4 py-2.5 text-sm font-medium transition-all sm:col-span-4 lg:col-span-1',
