  ...
  <header class="app-header">
    <div class="app-header-inner">
      ...
      <div class="flex min-w-0 items-center gap-1.5 sm:gap-3">
        ...
        >
          <svg
            class="h-4 w-4 text-[#8f4d35] dark:text-[#e4b391]"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            stroke-width="1.5"
          ...
          <span class="text-sm font-semibold text-[#2f2923] dark:text-[#f4efe7]">
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          ...
          >
            ...
            <div class="hidden text-left md:block">
              <div class="text-sm font-medium text-[#2f2923] dark:text-[#f4efe7]">
                {{ displayName }}
              </div>
              <div class="text-xs capitalize text-[#8a7d70] dark:text-[#9f9286]">
                {{ user.role }}
              </div>
            </div>
            <Icon name="chevronDown" size="sm" class="hidden text-[#9b8d7d] md:block" />
          </button>
